...
children.push(
  new Paragraph({
    children: [
      new TextRun({
        text: "DOCUMENTO FUNDACIONAL V07",
        bold: true,
        size: 40,
        font: "Arial",
        color: DARK_BLUE,
...
children.push(
  threeColTable(
    ...
    [
      ["BibloRed (biblored.gov.co)", "167 (89%)", "165 / 167 (99%)"],
      ["Alcaldía de Bogotá (bogota.gov.co)", "21 (11%)", "20 / 21 (95%)"],
    ],
    [50, 25, 25]
  )
);
...
children.push(spacer());
children.push(new Paragraph({ children: [new TextRun({ text: "Cobertura de tests (v0.7):", bold: true, size: 20, font: "Arial", color: DARK_BLUE })], spacing: { before: 80, after: 60 } }));
children.push(spacer(0.5));
children.push(
  threeColTable(
    ...
    [
      ...
      ["gemini.analyzer.ts", "98.8%", "18 tests"],
      ["pipeline.ts", "100%", "13 tests"],
      ["cheerio.extractor.ts", "91.4%", "15 tests"],
      ["activities.service.ts", "100% funciones", "—"],
      ["TOTAL PROYECTO", "95.8% líneas", "193 tests"],
    ],
    [50, 25, 25]
  )
);
...
children.push(
  new Paragraph({
    children: [
      new TextRun({
        text: "Documento generado automáticamente por Claude Code — Infantia v0.7 — 2026-03-16",
        size: 16,
        font: "Arial",
        color: "999999",
        italics: true,
...
const outputPath = process.env.OUTPUT_PATH || String.raw`C:\Users\denys\OneDrive\Documents\DayJul\Denys\Infantia\Infantia_Claude\Infantia_Documento_Fundacional_V07.docx`;
