...
children.push(new Paragraph({
  children: [new TextRun({ text: "2026-04-12", size: 24, font: "Arial", color: "777777" })],
  alignment: AlignmentType.CENTER, spacing: { before: 0, after: 80 },
}));
children.push(new Paragraph({
...
children.push(new Paragraph({
  children: [new TextRun({ text: "Documento generado automaticamente por Antigravity (Google DeepMind) — HabitaPlan v0.10.0-S41 (commits f8bd1db + 6bf69b5)", size: 18, font: "Arial", color: "BBBBBB", italics: true })],
  alignment: AlignmentType.CENTER,
}));
...
children.push(twoColTable(
  ...
  [
    ...
    ["Centro de Seguridad SSOT", "NUEVO V24 — /seguridad/* con PDFs legales descargables, arquitectura Single Source of Truth"],
    ["Cumplimiento Ley 1581 SIC", "NUEVO V24 — Privacidad, Terminos y Tratamiento de Datos alineados a SIC Colombia, descargables en PDF"],
...
children.push(twoColTable(
  ...
  [
    ...
    ["PDF legal", "NUEVO V24 — @react-pdf/renderer (serverExternalPackages) — generacion server-side"],
...
children.push(twoColTable(
  ...
  [
    ...
    ["src/app/seguridad/", "NUEVO V24 — Hub Centro de Seguridad con 3 subpaginas legales"],
    ["src/app/seguridad/privacidad/", "NUEVO V24 — Pagina Politica de Privacidad con descarga PDF"],
    ["src/app/seguridad/terminos/", "NUEVO V24 — Pagina Terminos de Uso con descarga PDF"],
    ["src/app/seguridad/datos/", "NUEVO V24 — Pagina Tratamiento de Datos Personales (SIC) con descarga PDF"],
    ["src/app/api/legal/privacidad/pdf/", "NUEVO V24 — API Route: genera PDF Privacidad server-side"],
    ["src/app/api/legal/terminos/pdf/", "NUEVO V24 — API Route: genera PDF Terminos server-side"],
    ["src/app/api/legal/datos/pdf/", "NUEVO V24 — API Route: genera PDF Tratamiento de Datos server-side"],
    ["src/modules/legal/constants/", "NUEVO V24 — SSOT: privacy.ts, terms.ts, data-treatment.ts"],
    ["src/modules/legal/components/", "NUEVO V24 — Componentes UI: PrivacyContent, TermsContent, DataTreatmentContent, DownloadPDFButton"],
    ["src/modules/legal/pdf/", "NUEVO V24 — PDFs: PrivacidadPDF, TermsPDF, DataTreatmentPDF (@react-pdf/renderer)"],
...
children.push(bodyParagraph("SSOT para documentos legales: src/modules/legal/constants/*.ts es la UNICA fuente — UI y PDF consumen las mismas constantes. NUEVO V24.", { bullet: true }));
...
// ── SECTION 5: CENTRO DE SEGURIDAD (NUEVO V24) ──────────────────────────────
children.push(sectionHeading("5. CENTRO DE SEGURIDAD LEGAL — NUEVO V24 (S41)"));
...
children.push(twoColTable(
  ...
  [
    ...
    ["/seguridad", "NUEVO V24 — Centro de Seguridad: hub de politicas legales"],
    ["/seguridad/privacidad", "NUEVO V24 — Politica de Privacidad + PDF descargable"],
    ["/seguridad/terminos", "NUEVO V24 — Terminos de Uso + PDF descargable"],
    ["/seguridad/datos", "NUEVO V24 — Tratamiento de Datos Personales (SIC) + PDF descargable"],
...
children.push(bodyParagraph("Cumplimiento Ley 1581 / SIC: NUEVO V24 — /seguridad/* con documentos SSOT y PDFs descargables.", { bullet: true }));
...
children.push(sectionHeading("14. ESTADO ACTUAL — v0.10.0-S41 (2026-04-12)"));
children.push(twoColTable(
  ["Metrica", "Valor"],
  [
    ...
    ["Tests", "882 tests en 56 archivos — 100% pasando"],
    ...
    ["Deployment", "Vercel ACTIVO en habitaplan.com — commit f8bd1db (09:18 AM COL, 2026-04-12)"],
...
children.push(threeColTable(
  ...
  [
    ...
    ["v0.9.8-S40", "V23", "Buscador mixto (acts+cats+ciudades), 3 bugs autocomplete. 882 tests."],
    ["v0.10.0-S41 (f8bd1db)", "V24", "Centro de Seguridad SSOT, PDFs Ley 1581 / SIC, Minor Bump. 882 tests."],
  ],
  [25, 12, 63]
));
children.push(spacer());
...
children.push(twoColTable(
  ...
  [
    ...
    ["Tests totales", "882 en 56 archivos"],
...
children.push(twoColTable(
  ...
  [
    ...
    ["npm test", "Correr todos los tests (882 tests)"],
...
children.push(new Paragraph({
  children: [new TextRun({ text: "Generado por Antigravity (Google DeepMind) el 2026-04-12 | Software: v0.10.0-S41 (commits f8bd1db + 6bf69b5) | 882 tests | 56 archivos | 0 errores TS", size: 16, font: "Arial", color: "BBBBBB" })],
  alignment: AlignmentType.CENTER,
}));
