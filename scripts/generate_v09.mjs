...
children.push(
  new Paragraph({
    children: [
      new TextRun({
        text: "DOCUMENTO FUNDACIONAL V09",
        bold: true,
        size: 40,
        font: "Arial",
        color: DARK_BLUE,
...
children.push(
  new Paragraph({
    children: [new TextRun({ text: "2026-03-17", size: 24, font: "Arial", color: "777777" })],
    alignment: AlignmentType.CENTER,
...
children.push(
  new Paragraph({
    children: [
      new TextRun({
        text: "Documento generado automaticamente por Claude Code — Infantia v0.9",
        size: 18,
        font: "Arial",
        color: "999999",
        italics: true,
...
children.push(bodyParagraph("Para familias: Un solo lugar para descubrir todas las actividades disponibles para sus hijos, con filtros por edad, precio, ubicacion y categoria."));
...
for (const c of [
  ...
  "NLP: Prompt Gemini especifico para Instagram (hashtags como categorias, emojis como indicadores)",
...
for (const item of [
  ...
  ["NLP", "Gemini 2.5 Flash, temperatura 0.1 para maxima consistencia"],
...
children.push(sectionHeading("10. FRONTEND — ESTADO ACTUAL (v0.9)"));
...
children.push(
  threeColTable(
    ...
    [
      ...
      ["/actividades (listado + filtros)", "Server + Client", "Funcional"],
...
children.push(spacer());
children.push(new Paragraph({ children: [new TextRun({ text: "Tests — cobertura (v0.9):", bold: true, size: 20, font: "Arial", color: DARK_BLUE })], spacing: { before: 80, after: 60 } }));
children.push(spacer(0.5));
children.push(
  threeColTable(
    ...
    [
      ...
      ["activities.service.ts", "100%", "17"],
      ["children API (GET, POST, DELETE)", "—", "13"],
      ["Auth (login, registro, perfil, admin)", "—", "~50"],
      ["Resto modulos (middleware, utils, etc.)", "—", "~138"],
      ["TOTAL PROYECTO", "~95%", "307"],
    ],
    [50, 25, 25]
  )
);
...
for (const t of [
  "Formulario de contacto con motivo 'Solicitud de remocin de contenido'",
...
children.push(
  threeColTable(
    ...
    [
      ...
      ["Fase 1 MVP", "307 tests (cobertura ~95%)", "Completado"],
...
children.push(
  new Paragraph({
    children: [
      new TextRun({
        text: "Documento generado automaticamente por Claude Code — Infantia v0.9 — 2026-03-17",
        size: 16,
        font: "Arial",
        color: "999999",
        italics: true,
...
const outputPath = process.env.OUTPUT_PATH || String.raw`C:\Users\denys\OneDrive\Documents\DayJul\Denys\Infantia\Infantia_Claude\Infantia_Documento_Fundacional_V09.docx`;
