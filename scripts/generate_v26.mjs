...
children.push(new Paragraph({
  children: [new TextRun({ text: "DOCUMENTO FUNDACIONAL V26", bold: true, size: 40, font: "Arial", color: DARK_BLUE })],
...
children.push(new Paragraph({
  children: [new TextRun({ text: "Documento generado automaticamente por Antigravity (Google DeepMind) — HabitaPlan v0.12.0-S42 (commits f8bd1db + a3d7dc9)", size: 18, font: "Arial", color: "BBBBBB", italics: true })],
  alignment: AlignmentType.CENTER,
}));
...
children.push(twoColTable(
  ...
  [
    ...
    ["Centro de Seguridad SSOT", "NUEVO V26 — /seguridad/* con PDFs legales descargables, arquitectura Single Source of Truth"],
    ["Cumplimiento Ley 1581 SIC", "NUEVO V26 — Privacidad, Terminos y Tratamiento de Datos alineados a SIC Colombia, descargables en PDF"],
...
children.push(twoColTable(
  ...
  [
    ...
    ["PDF legal", "NUEVO V26 — @react-pdf/renderer (serverExternalPackages) — generacion server-side"],
...
children.push(twoColTable(
  ...
  [
    ...
    ["src/app/seguridad/", "NUEVO V26 — Hub Centro de Seguridad con 3 subpaginas legales"],
    ["src/app/seguridad/privacidad/", "NUEVO V26 — Pagina Politica de Privacidad con descarga PDF"],
    ["src/app/seguridad/terminos/", "NUEVO V26 — Pagina Terminos de Uso con descarga PDF"],
    ["src/app/seguridad/datos/", "NUEVO V26 — Pagina Tratamiento de Datos Personales (SIC) con descarga PDF"],
    ["src/app/api/legal/privacidad/pdf/", "NUEVO V26 — API Route: genera PDF Privacidad server-side"],
    ["src/app/api/legal/terminos/pdf/", "NUEVO V26 — API Route: genera PDF Terminos server-side"],
    ["src/app/api/legal/datos/pdf/", "NUEVO V26 — API Route: genera PDF Tratamiento de Datos server-side"],
    ["src/modules/legal/constants/", "NUEVO V26 — SSOT: privacy.ts, terms.ts, data-treatment.ts"],
    ["src/modules/legal/components/", "NUEVO V26 — Componentes UI: PrivacyContent, TermsContent, DataTreatmentContent, DownloadPDFButton"],
    ["src/modules/legal/pdf/", "NUEVO V26 — PDFs: PrivacidadPDF, TermsPDF, DataTreatmentPDF (@react-pdf/renderer)"],
...
children.push(bodyParagraph("SSOT para documentos legales: src/modules/legal/constants/*.ts es la UNICA fuente — UI y PDF consumen las mismas constantes. NUEVO V26.", { bullet: true }));
...
// ── SECTION 5: CENTRO DE SEGURIDAD (NUEVO V26) ──────────────────────────────
children.push(sectionHeading("5. CENTRO DE SEGURIDAD LEGAL — NUEVO V26 (S41)"));
...
children.push(twoColTable(
  ...
  [
    ...
    ["/seguridad", "NUEVO V26 — Centro de Seguridad: hub de politicas legales"],
    ["/seguridad/privacidad", "NUEVO V26 — Politica de Privacidad + PDF descargable"],
    ["/seguridad/terminos", "NUEVO V26 — Terminos de Uso + PDF descargable"],
    ["/seguridad/datos", "NUEVO V26 — Tratamiento de Datos Personales (SIC) + PDF descargable"],
...
children.push(bodyParagraph("Cumplimiento Ley 1581 / SIC: NUEVO V26 — /seguridad/* con documentos SSOT y PDFs descargables.", { bullet: true }));
...
children.push(sectionHeading("14. ESTADO ACTUAL — v0.12.0-S42 (2026-04-13)"));
children.push(twoColTable(
  ["Metrica", "Valor"],
  [
...
children.push(threeColTable(
  ...
  [
    ...
    ["v0.12.0-S42 (f8bd1db)", "V26", "Centro de Seguridad SSOT, PDFs Ley 1581 / SIC, Minor Bump. 889 tests."],
    ["v0.12.0-S42 (a3d7dc9)", "V26", "Hardening critico estabilidad de precios y schema validator. 889 tests."],
  ],
  [25, 12, 63]
));
children.push(spacer());
...
children.push(twoColTable(
  ...
  [
    ...
    ["Documento Fundacional V26", "Cuando se complete el proximo milestone significativo"],
  ]
));
children.push(spacer());
...
children.push(twoColTable(
  ...
  [
    ...
    ["node scripts/generate_v24.mjs", "Generar este Documento Fundacional V26"],
  ]
));
children.push(spacer());
...
children.push(new Paragraph({ children: [new PageBreak()] }));
children.push(new Paragraph({
  children: [new TextRun({ text: "HabitaPlan — Documento Fundacional V26", size: 18, font: "Arial", color: "999999", italics: true })],
  alignment: AlignmentType.CENTER, spacing: { before: 400, after: 80 },
}));
children.push(new Paragraph({
  children: [new TextRun({ text: "Generado por Antigravity (Google DeepMind) el 2026-04-13 | Software: v0.12.0-S42 (commits f8bd1db + a3d7dc9) | 889 tests | 58 archivos | 0 errores TS", size: 16, font: "Arial", color: "BBBBBB" })],
  alignment: AlignmentType.CENTER,
}));
  ...
  sections: [
    {
      headers: {
        default: new Header({
          children: [
            new Paragraph({
              children: [new TextRun({ text: "HABITAPLAN — DOCUMENTO FUNDACIONAL V26", size: 16, font: "Arial", color: "999999" })],
...
const OUTPUT_PATH = "C:\\Users\\denys\\OneDrive\\Documents\\DayJul\\Denys\\Infantia\\Infantia_Claude\\HabitaPlan_Documento_Fundacional_V26.docx";
