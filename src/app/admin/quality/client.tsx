...
export default function QualityDashboardClient() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-12 px-6">
      ...
      <div className='bg-[var(--hp-bg-surface)] p-4 rounded-xl border border-[var(--hp-border)] shadow-[var(--hp-shadow-md)] mb-8 flex flex-wrap gap-4 items-end'>
        <div>
      ...
      {status === 'over' && (
        <div className='bg-error-50 border-l-4 border-error-500 p-4 mb-8 rounded-md shadow-[var(--hp-shadow-md)]'>
          <div className="flex">
      ...
      {status === 'under' && (
        <div className='bg-warning-50 border-l-4 border-warning-500 p-4 mb-8 rounded-md shadow-[var(--hp-shadow-md)]'>
          <div className="flex">
      ...
      {status === 'healthy' && (
        <div className='bg-success-50 border-l-4 border-success-500 p-4 mb-8 rounded-md shadow-[var(--hp-shadow-md)]'>
          <div className="flex">
            <div className="flex-shrink-0 text-xl">✅</div>
            <div className="ml-3">
      ...
      {latest && (
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className='bg-[var(--hp-bg-surface)] p-6 rounded-2xl border border-[var(--hp-border)] shadow-[var(--hp-shadow-md)] flex flex-col justify-center'>
      ...
      {loading ? (
        ...
        <div className='bg-[var(--hp-bg-page)] text-center py-16 rounded-2xl border border-[var(--hp-border)] shadow-[var(--hp-shadow-md)] text-[var(--hp-text-secondary)]'>
           No hay métricas recopiladas todavía. Corre el script de backfill primero.
        </div>
      ) : (
        <div className="space-y-8">
          
          <section className='bg-[var(--hp-bg-surface)] p-6 rounded-2xl border border-[var(--hp-border)] shadow-[var(--hp-shadow-md)]'>
            <div className="mb-6">
