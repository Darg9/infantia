      ...
      <section className="bg-[var(--hp-bg-surface)] border-b border-[var(--hp-border)]">
        <div className="mx-auto max-w-5xl px-4 pt-6 pb-5 sm:pt-8 sm:pb-6 text-center">
          ...
          <div className="flex gap-2 justify-center mt-3 flex-nowrap">
            <Link href="/actividades?dateRange=today"  className='inline-flex items-center px-3 py-1.5 rounded-full border border-[var(--hp-border-subtle)] bg-[var(--hp-bg-elevated)] text-sm text-[var(--hp-text-primary)] hover:bg-[var(--hp-bg-subtle)] hover:border-brand-400 hover:text-brand-600 shadow-[var(--hp-shadow-md)] font-medium transition-all whitespace-nowrap'>Hoy</Link>
          ...
          {(hasRecent || hasPopular) ? (
            <>
              ...
              <div className="mt-8 text-center">
                <Link
                  href={activityHref}
                  className='inline-flex items-center gap-2 rounded-full border-2 border-hp-action-primary px-8 py-3 text-sm font-semibold text-hp-action-primary hover:bg-hp-action-primary hover:text-white hover:shadow-[var(--hp-shadow-md)] transition-all'
                >
