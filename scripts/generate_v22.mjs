...
children.push(new Paragraph({
  children: [new TextRun({ text: "DOCUMENTO FUNDACIONAL V22", bold: true, size: 40, font: "Arial", color: DARK_BLUE })],
...
children.push(new Paragraph({
  children: [new TextRun({ text: "2026-04-06", size: 24, font: "Arial", color: "777777" })],
  alignment: AlignmentType.CENTER, spacing: { before: 0, after: 80 },
}));
children.push(new Paragraph({
  children: [new TextRun({ text: "Sesiones S27-S31 — Telegram, Provider Claim, Instagram Multi-Fuente, Cache BD, Ranking Fuentes", size: 20, font: "Arial", color: "999999", italics: true })],
  alignment: AlignmentType.CENTER, spacing: { before: 0, after: 1200 },
}));
children.push(new Paragraph({
  children: [new TextRun({ text: "Documento generado automaticamente por Claude Code — Infantia v0.9.3-S31 (commits 5880b2d → 432b9b0)", size: 18, font: "Arial", color: "BBBBBB", italics: true })],
  alignment: AlignmentType.CENTER,
}));
...
children.push(bodyParagraph("Formato de linea: 2026-04-06T22:00:00Z INFO  [ctx] mensaje {\"meta\":\"json\"}", { bullet: true }));
...
children.push(bodyParagraph("Resultado al 2026-04-06: 29/29 locations en BD con coordenadas reales (lat/lng != 0).", { bullet: true }));
children.push(spacer());
...
children.push(sectionHeading("14. ESTADO ACTUAL — v0.9.3-S31 (2026-04-06)"));
children.push(twoColTable(
  ["Metrica", "Valor"],
  [
...
children.push(spacer());
children.push(subHeading("Tests nuevos en V22 (S27-S31)"));
...
children.push(twoColTable(
  ...
  [
    ...
    ["node scripts/generate_v22.mjs", "Generar este Documento Fundacional V22"],
  ]
));
children.push(spacer());
...
children.push(new Paragraph({ children: [new PageBreak()] }));
children.push(new Paragraph({
  children: [new TextRun({ text: "Infantia — Documento Fundacional V22", size: 18, font: "Arial", color: "999999", italics: true })],
  alignment: AlignmentType.CENTER, spacing: { before: 400, after: 80 },
}));
children.push(new Paragraph({
  children: [new TextRun({ text: "Generado por Claude Code el 2026-04-06 | Software: v0.9.3-S31 (5880b2d → 432b9b0) | 797 tests | 53 archivos | 0 vulnerabilidades npm", size: 16, font: "Arial", color: "BBBBBB" })],
  alignment: AlignmentType.CENTER,
}));
  ...
  sections: [
    {
      headers: {
        default: new Header({
          children: [
            new Paragraph({
              children: [new TextRun({ text: "INFANTIA — DOCUMENTO FUNDACIONAL V22", size: 16, font: "Arial", color: "999999" })],
...
const OUTPUT_PATH = "C:\\Users\\denys\\OneDrive\\Documents\\DayJul\\Denys\\Infantia\\Infantia_Claude\\Infantia_Documento_Fundacional_V22.docx";
