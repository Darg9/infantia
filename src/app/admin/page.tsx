    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          ...
          <p className="text-sm text-[var(--hp-text-secondary)] mt-1">Ver estado de las fuentes configuradas</p>
        </Link>
        ...
        >
          ...
          <p className="text-sm text-[var(--hp-text-secondary)] mt-1">Historial de scraping y resultados</p>
        </Link>
        ...
        >
          ...
          <p className="text-sm text-[var(--hp-text-secondary)] mt-1">Editar, ocultar y revisar actividades</p>
        </Link>
        ...
        >
          ...
          <p className="text-sm text-[var(--hp-text-secondary)] mt-1">Vistas, búsquedas frecuentes y distribución</p>
        </Link>

        <Link
          href="/admin/sponsors"
          className='bg-[var(--hp-bg-surface)] border border-[var(--hp-border)] rounded-2xl p-6 hover:border-warning-300 hover:shadow-[var(--hp-shadow-md)] transition-all'
        >
          <div className="text-2xl mb-2">💛</div>
        ...
        >
          ...
          <p className="text-sm text-[var(--hp-text-secondary)] mt-1">Monitoreo de calidad y auto-pause de fuentes</p>
        </Link>
        ...
        >
          ...
          <p className="text-sm text-[var(--hp-text-secondary)] mt-1">Monitor de pipeline: ruido, longitud y alertas</p>
        </Link>
        ...
        >
          ...
          <p className="text-sm text-[var(--hp-text-secondary)] mt-1">Resuelve ambigüedades de ciudad con baja confianza</p>
        </Link>
