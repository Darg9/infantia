      ...
      <main className="min-h-screen bg-[var(--hp-bg-page)] pb-20">
        ...
        <section className="bg-[var(--hp-bg-surface)] border-b border-[var(--hp-border)] pt-12 pb-16 px-4">
          <div className="max-w-6xl mx-auto text-center space-y-6">
            ...
            <div className="pt-4">
              <Link href={`/actividades?cityId=${city.id}`} className='inline-flex items-center justify-center rounded-full bg-brand-600 px-8 py-3.5 text-base font-semibold text-white shadow-[var(--hp-shadow-md)] hover:bg-brand-500 transition-colors'>
        ...
        <section className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="mt-10 text-center">
            <Link href={`/actividades?cityId=${city.id}`} className='inline-flex items-center justify-center rounded-xl bg-[var(--hp-bg-surface)] border border-[var(--hp-border)] px-6 py-3 text-sm font-semibold text-[var(--hp-text-primary)] shadow-[var(--hp-shadow-md)] hover:bg-[var(--hp-bg-subtle)] transition-colors'>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {popularCategories.map((cat) => (
                <Link key={cat.id} href={`/actividades/categoria/${cat.slug}?cityId=${city.id}`} className='flex flex-col items-center justify-center gap-3 bg-[var(--hp-bg-surface)] p-6 rounded-2xl border border-[var(--hp-border)] hover:border-brand-300 hover:shadow-[var(--hp-shadow-md)] transition-all group'>
